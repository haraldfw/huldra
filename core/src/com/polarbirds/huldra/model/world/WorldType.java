...
public enum WorldType {
  ...
  /**
   * Change for rooms to be max size. The higher the number the closer to max size they will be. The
   * larger this float is, the more rooms will be max size. If this float is Float.MAX_VALUE, all
   * rooms will be max size.
   */
